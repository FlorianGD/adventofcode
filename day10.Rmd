...
We now have to do 64 rounds, in place of just one as above, but we must preserve the `position` and `skip length` from one round to the other.
Let's modify the `hash` function to return also those values.
```{r}
